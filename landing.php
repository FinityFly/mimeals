...
<html>
	<head>
		<title>MiMeals | Setting up</title>
						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<p>To personalize your experience with MiMeals, we kindly ask you to answer a few questions about what food means to you! This will take no longer than a minute.</p>

                                    <center>
									<ul class="pagination">
										<li><span class="button disabled">Back</span></li>
										<li><a href="#" class="page active">1</a></li>
										<li><a href="#" class="page">2</a></li>
										<li><a href="#" class="page">3</a></li>
										<li><a href="#" class="page">4</a></li>
										<li><a href="#" class="page">5</a></li>
										<li><a href="#" class="button">Alright</a></li>
